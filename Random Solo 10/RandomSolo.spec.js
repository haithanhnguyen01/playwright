...
test("Tidal design with multiple variants", async ({ page }) => {
    await page.goto('https://www.lodes.com/en/products/random-solo/?code=eu', { waitUntil: 'domcontentloaded' });
    ...
    const formatColorForURL = (colorName) =>
                colorName.normalize("NFD")                   // normalize accents (e.g., é → e)
            ...
            if (table) {
                ...
                for (const row of rows) {
                    ...
                    for (let i = 0; i < rowCount; i++) {
                        ...
                        const ColorUrl = `https://www.lodes.com/wp-content/uploads/2021/03/Random-Solo-${colorProduct}-${type}.png`;
