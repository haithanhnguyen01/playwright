...
test("Tidal design with multiple variants", async ({ page }) => {
    await page.goto('https://www.lodes.com/en/products/shift/?code=eu', { waitUntil: 'domcontentloaded' });
    ...
    for (let variantIndex = 0; variantIndex < count; variantIndex++) {
        ...
        if (await body.isVisible()) {
            ...
            const type = productName.split(' ')[1].toLowerCase();
            ...
            if (table) {
                ...
                for (const row of rows) {
                    ...
                    for (let i = 0; i < rowCount; i++) {
                        ...
                        const ColorUrl = `https://www.lodes.com/wp-content/uploads/2025/01/Shift-${type}-${colorProduct}.png`;
