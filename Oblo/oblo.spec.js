...
test("Tidal design with multiple variants", async ({ page }) => {
    await page.goto('https://www.lodes.com/en/products/oblo/?code=eu', { waitUntil: 'domcontentloaded' });
    ...
    for (let variantIndex = 0; variantIndex < count; variantIndex++) {
        ...
        if (await body.isVisible()) {
            ...
            let productDetails = [];
            const Text = await page.locator('.left.col25.font26.serif').nth(variantIndex).innerText();
            ...
            if (table) {
                ...
                for (const row of rows) {
                    ...
                    for (let i = 0; i < rowCount; i++) {
                        ...
                        const ColorUrl = `https://www.lodes.com/wp-content/uploads/2025/01/Oblo-${type}-${colorProduct}.png`;
                    ...
                    for (let i = 0; i < rowCount; i++) {
                        ...
                        const ColorUrl = `//www.lodes.com/wp-content/uploads/2024/08/Oblo-${type}-${colorProduct}-1.png`;
